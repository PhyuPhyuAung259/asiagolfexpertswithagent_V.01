<?php
namespace Themes\Golf\Golf\Blocks;
...
class ListEvent extends BaseBlock
{
    ...
    protected $golfClass;
    public function __construct(Golf $golfClass)
    {
        ...
        return [
            'settings' => [
                ...
                [
                    ...
                    'select2'      => [
                        'ajax'        => [
                            'url'      => route('golf.admin.getForSelect2'),
                            'dataType' => 'json'
                        ],
                        'width'       => '100%',
                        'multiple'    => "true",
                    ...
                    'pre_selected' => route('golf.admin.getForSelect2', [
                        'pre_selected' => 1
                    ])
                ],
            ],
    ...
    public function content($model = [])
    {
        ...
        return view('Event::frontend.blocks.list-golf.index', $data);
    }
    ...
    public function query($model){
        $listCar = $this->golfClass->search($model);
