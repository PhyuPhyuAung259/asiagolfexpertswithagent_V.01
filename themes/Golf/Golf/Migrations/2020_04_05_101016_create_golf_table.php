...
class CreateGolfTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bravo_golfs', function (Blueprint $table) {
        ...
        Schema::create('bravo_golf_translations', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_golf_term', function (Blueprint $table) {
            $table->bigIncrements('id');
        ...
        Schema::create('bravo_golf_dates', function (Blueprint $table) {
            $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('bravo_golfs');
        Schema::dropIfExists('bravo_golf_translations');
        Schema::dropIfExists('bravo_golf_dates');
        Schema::dropIfExists('bravo_golf_term');
    }
}
