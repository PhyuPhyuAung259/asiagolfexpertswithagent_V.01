...
class RouterServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Themes\Golf\Golf\Controllers';

    protected $adminModuleNamespace = 'Themes\Golf\Golf\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix(config('admin.admin_route_prefix').'/module/golf')
