...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Golf Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Golf Sale Price")}}">
                        <span><i>{{__("If the regular price is less than the discount , it will show the regular price")}}</i></span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Cart Price")}}</label>
                        <input type="number" step="any" min="0" name="cart_price" class="form-control" value="{{$row->cart_price}}" placeholder="{{__("Golf Cart Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Cart Sharing Price")}}</label>
                        <input type="number" step="any" name="cart_sharing_price" class="form-control" value="{{$row->cart_sharing_price}}" placeholder="{{__("Golf Cart Sharing")}}">
                    </div>
                </div>
            </div>
                    ...
                    <div class="item" data-number="__number__">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number"  min="0" __name__="ticket_types[__number__][number]" class="form-control" value="0" placeholder="{{ __("Number Ticket") }}">
                            </div>
                            <div class="col-md-1">
                                <span class="btn btn-danger btn-sm btn-remove-item"><i class="fa fa-trash"></i></span>
                            </div>
        ...
        @if(is_default_lang() and (!empty(setting_item("golf_allow_vendor_can_add_service_fee")) or is_admin()))
            <hr>
