...
@section('content')
    <div class="bravo_search_tour bravo_search_event">
        <h1 class="d-none">
            {{setting_item_with_lang("golf_page_search_title")}}
        </h1>
        <div class="bravo_form_search_map">
            @include('Golf::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map {{ setting_item_with_lang("golf_layout_map_option",false,"map_left") }}">
            ...
            <div class="results_item">
                @include('Golf::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Golf::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
