...
<div class="shadow-soft bg-white rounded-sm booking-review">
    <div class="pt-3 pb-3 px-4 border-bottom">
    ...
    <div id="basicsAccordionBooking">
        <div class="card rounded-0 border-top-0 border-left-0 border-right-0">
            <div class="card-header card-collapse bg-transparent border-0 px-0">
                <h5 class="mb-0">
                ...
                <div class="card-body px-4 pt-0">
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        @if($booking->start_date)
                            ...
                            @if($price_rows = $booking->getJsonMeta("price_rows"))
                                <li class="pt-3">
                                    <table class="table none-mgb font-size-14">
                                        ...
                                        <tbody>
                                            @foreach($price_rows as $item)
                                                <tr>
                                                    <td>{{ $item['player'] }}</td>
                                                    <td class="teetimerate">{{format_money( $item['rate']) }}</td>
                                                    <td class="golfcartfee">{{ format_money($item['cart']) }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
        ...
        <div class="card rounded-0 border-top-0 border-left-0 border-right-0">
            <div class="card-header card-collapse bg-transparent border-0 px-0" id="basicsHeadingFour">
                <h5 class="mb-0">
            ...
            <div id="basicsCollapsePayment" class="collapse show">
                <div class="card-body px-4 pt-0">
                    <ul class="list-unstyled font-size-1 mb-0 font-size-16">
                        ...
                        <li class="d-flex justify-content-between py-2">
                            <div class="label">{{ $booking->total_guests }} {{ __("Guests") }}</div>
                            <div class="val">
