<div class="item filter-item">
    @if(setting_item('golf_location_search_style')=='autocompletePlace')
        <div class="mb-0">
        ...
        <div class="mb-0">
            <div class="input-group border-bottom border-width-2 border-color-1">
                ...
                <div class="smart-search border-0 p-0 form-control  height-40">
                    <input type="text" class="smart-search-location parent_text  font-weight-bold font-size-16 shadow-none hero-form font-weight-bold border-0 p-0" {{ ( empty(setting_item("golf_location_search_style")) or setting_item("golf_location_search_style") == "normal" ) ? "readonly" : ""  }} placeholder="{{__("Where are you going?")}}" value="{{ $location_name }}" data-onLoad="{{__("Loading...")}}"
