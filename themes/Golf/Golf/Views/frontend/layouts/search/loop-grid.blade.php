...
<div class="item-loop relative {{$wrap_class ?? ''}}">
    ...
    @if($row->is_featured == "1")
        <div class="position-absolute top-0 left-0 pt-3 pl-3 featured">
            <span class="badge font-weight-normal badge-pill px-4 mr-3 py-2">{{ __("Popular") }}</span>
        </div>
    @endif
        ...
        <div class="info1 mx-3">
            ...
            <div class="g-price">
                <div class="prefix">
                    ...
                    <span class=""><a href="{{$row->getDetailUrl($include_param ?? true)}}" class="btn btn-sm " style="background-color: green; color: white;float: right;">Book Now</a></span>
                </div>
            </div>
        </div>
