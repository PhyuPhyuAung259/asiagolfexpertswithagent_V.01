...
@push('js')
    ...
    <script>
        var time_slots = {!! json_encode((new Themes\Golf\Golf\Models\Golf())->generateTimeSlots()) !!}
        ...
        $('#items_tab').on('show.bs.tab',function (e) {
            ...
            calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events:{
                    url:"{{route('golf.vendor.availability.loadDates')}}",
                    extraParams:{
                        id:lastId,
                    }
                },
        ...
        formModal = new Vue({
            ...
            methods:{
                ...
                saveForm:function () {
                    ...
                    $.ajax({
                        url:'{{route('golf.vendor.availability.store')}}',
                        data:this.form,
                        dataType:'json',
                        method:'post',
