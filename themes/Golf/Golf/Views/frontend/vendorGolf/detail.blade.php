...
@section('content')
    <h2 class="title-bar no-border-bottom">
        {{$row->id ? __('Edit: ').$row->title : __('Add new golf course')}}
    </h2>
    ...
    <div class="lang-content-box">
        <form action="{{route('golf.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
            @csrf
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        @include('Golf::admin/golf/location',["is_smart_search"=>"1"])
                    </div>
