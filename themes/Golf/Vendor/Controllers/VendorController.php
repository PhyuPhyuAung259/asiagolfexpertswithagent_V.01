...
namespace Themes\Golf\Vendor\Controllers;
...
class VendorController extends \Modules\Vendor\Controllers\VendorController
{
    ...
    public function register(Request $request)
    {
        ...
        $messages = [
            ...
            'role_id.required'       => __('The type field is required'),
        ];
        ...
        if ($validator->fails()) {
            ...
            if(in_array($role_id,[1,3])){
                $errors = new MessageBag(['role_id' => __('Please select valid type')]);
                return response()->json([
                    'error'    => true,
                    'messages' => $errors
                ], 200);
            ...
            $dataVendor['role_request'] = $role_id;
