...
$roles = Role::query()->whereNotIn('id',[1,3])->get();
?>
<div class="container">
            ...
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('vendor.register')}}">
                    ...
                    <div class="form-group">
                        ...
                        <span class="invalid-feedback error error-role_id"></span>
                    </div>
...
@push('js')
    <script type="text/javascript" src="{{ asset("/themes/golf/module/vendor/js/vendor-register.js?_ver=".config('app.version')) }}"></script>
@endpush
